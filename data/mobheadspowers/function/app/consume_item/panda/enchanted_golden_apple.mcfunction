advancement revoke @s only mobheadspowers:consume_item/panda/enchanted_golden_apple

execute store result score @s mobheadspowers.random_consume run random value 0..1

execute if score @s mobheadspowers.random_consume matches 0 run give @s enchanted_golden_apple
