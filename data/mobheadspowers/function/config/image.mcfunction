function mobheadspowers:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    {translate: "mobheadspowers.description", fallback: "Gives the wearer a status effect based on the mob head equipped", color: "#aaaaaa"},\
    "",\
