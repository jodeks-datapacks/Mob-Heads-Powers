scoreboard players set @s mob_heads_powers.config 0

$dialog show @s {\
type:"minecraft:multi_action",\ 
  title: {\
    "translate": "mob_heads_powers.config",\
  ...
  "body": [\
    {\
      ...
      "contents": {\
        "translate": "mob_heads_powers.config.description",\
  ...
  [\
    ...
    {\
      ...
      key:"dialog_aquatic",\
      label: {\
        "translate": "mob_heads_powers.aquatic",\
        "fallback": "Aquatic",\
        "extra": [\
          {\
            "text": " "\
    ...
    {\
      ...
      label: {\
        "translate": "mob_heads_powers.entity.oxidized",\
        "extra": [\
          {\
            "text": " "\
          },\
    ...
    {\
      ...
      label: {\
        "translate": "mob_heads_powers.entity.charged_creeper",\
    ...
    {\
      ...
      key:"dialog_fish",\
      label: {\
        "translate": "mob_heads_powers.entity.fish",\
        "fallback": "Fish",\
        "extra": [\
          {\
            "text": " "\
    ...
    {\
      ...
      label: {\
        ...
        "extra": [\
          ...
          {\
            "translate": "mob_heads_powers.advancement.collection.boss.wither.invulnerable",\
  ...
  actions:[\
    {\
      ...
      action:{\
        type:"run_command",\
        command:"function mob_heads_powers:config/reset/dialog_config"\
      }\
    }\
  ]\
}